<header class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-black text-sm py-3 md:py-0" style="background-color: black;">
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid">
            ...
            <a wire:navigate class="font-medium {{request()->is('/')?'text-amarillo':'text-white'}} py-3 md:py-6" href="/" aria-current="page">
              Inicio
            </a>

            <a wire:navigate class="font-medium {{request()->is('categories')?'text-amarillo':'text-white'}} py-3 md:py-6 " href="/categories">
              Categorias
            </a>

            <a wire:navigate class="font-medium {{request()->is('products')?'text-amarillo':'text-white'}} py-3 md:py-6" href="/products">
              Productos
            </a>

            <a wire:navigate class="font-medium flex items-center {{request()->is('cart')?'text-amarillo':'text-gray-500'}} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/cart">
              ...
              <span class="mr-1">Compras</span> <span class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-white border border-yellow-300 text-black">0</span>
            </a>

            <div class="pt-3 md:pt-0">
              <a wire:navigate class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-yellow-400 text-black hover:bg-yellow-500 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/login">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-black md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
