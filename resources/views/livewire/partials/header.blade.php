      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid">
            ...
            <a wire:navigate class="font-medium {{request()->is('/')?'text-blue-600':'text-white'}} py-3 md:py-6" href="/" aria-current="page">
              Inicio
            </a>

            <a wire:navigate class="font-medium {{request()->is('categories')?'text-red-600':'text-white'}} py-3 md:py-6 " href="/categories">
              Categorias
            </a>

            <a wire:navigate class="font-medium {{request()->is('products')?'text-blue-600':'text-white'}} py-3 md:py-6" href="/products">
              Productos
            </a>
