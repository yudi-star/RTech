      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        ...
        <div class="col-span-1">
          ...
          <div class="mt-3 grid space-y-3">
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-yellow-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/categories">Atencion al cliente</a></p>
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col-span-1">
          ...
          <div class="mt-3 grid space-y-3">
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-yellow-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Blog</a></p>
  
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-yellow-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Clientes</a></p>
          </div>
        </div>
        <!-- End Col -->
