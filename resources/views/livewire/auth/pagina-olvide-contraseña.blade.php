          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a class="text-yellow-400 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/login">
                  Inicia sesión aquí
                </a>
              </p>
            </div>
              ...
              <form>
                <div class="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <p class="hidden text-xs text-red-600 mt-2" id="email-error">Por favor, incluya un correo electrónico válido</p>
                  </div>
                  <!-- End Form Group -->
